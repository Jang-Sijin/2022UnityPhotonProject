...
namespace Complete
{
    public class TankShooting : MonoBehaviourPunCallbacks // MonoBehaviour
    {
        public PhotonView PV;
        
        public int m_PlayerNumber = 1;              // Used to identify the different players.
        public Rigidbody m_Shell;                   // Prefab of the shell.
        public GameObject CompleteShellGameObject;
        ...
        private void FireRPC()
        {
            ...
            // [Photon Test]
            CompleteShellGameObject = PhotonNetwork.Instantiate("CompleteShell", m_FireTransform.position, m_FireTransform.rotation);
